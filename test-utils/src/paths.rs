...
pub const CRYPTO_PAIR_BIN_PATH: &str = "../crypto-pair/out/debug/crypto-pairs.bin";
pub const CRYPTO_PAIR_ABI_PATH: &str = "../crypto-pair/out/debug/crypto-pairs-abi.json";
...
pub const CRYPTO_PAIR_STORAGE_PATH: &str = "../crypto-pair/out/debug/crypto-pairs-storage_slots.json";